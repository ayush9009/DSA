...
public:
    ...
    int maximumDetonation(vector<vector<int>>& bombs) {
        //directed graph kuki ye jarori ni ki x ki radius mai y ara to ,y ki radius mai x bhi ayega
        int n=bombs.size();
        vector<vector<int>>adj(n);   //vectorofvector ek node se kahi node connect ho sake
